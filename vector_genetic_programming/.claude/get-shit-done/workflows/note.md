...
- **Global scope**: `/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/notes/`)
...
2. Glob `/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/notes/` — works in any directory
