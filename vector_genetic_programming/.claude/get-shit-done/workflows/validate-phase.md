...
```
Task(
  prompt="Read /Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/get-shit-done/templates/VALIDATION.md`
