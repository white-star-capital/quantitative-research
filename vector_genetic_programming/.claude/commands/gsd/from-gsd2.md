...
1. **Locate the .gsd/ directory** — check the current working directory (or `--path` argument):
   ```bash
   node "/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/get-shit-done/bin/gsd-tools.cjs" from-gsd2 --dry-run
   ```
...
3. **Run the migration** after confirmation:
   ```bash
   node "/Users/ale/Documents/quantitative-research/vector_genetic_programming/.claude/get-shit-done/bin/gsd-tools.cjs" from-gsd2
   ```
